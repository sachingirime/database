...
public:
	...
	// return	positive number when there is a condition on schema
	// 			0 when there is no condition on schema
	//			-1 on error
	...
	// return	positive number when there is a condition on schemas
	// 			0 when there is no condition on schemas
	//			-1 on error
